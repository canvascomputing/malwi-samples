...
from aiohttp_socks_test_connector.errors import ProxyError
from aiohttp_socks_test_connector.proto import Socks4SocketWrapper, Socks5SocketWrapper, ProxyType
